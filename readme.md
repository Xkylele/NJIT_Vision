...
7. 串口设置
    ...
    3. 创建 udev 规则文件
        ...
        SUBSYSTEM=="tty", KERNELS=="1-2:1.0", SYMLINK+="gimbal"
...
Type=simple
User=lele
WorkingDirectory=/home/lele/Desktop/sp_vision_25

ExecStart=/home/lele/Desktop/sp_vision_25/start_all.sh
